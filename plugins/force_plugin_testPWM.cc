  ...
  public: void ApplyForce6(const double &_force6, const double &_force6p)
    {
      ...
      this->force6=this->CalForce(_force6,this->pos,this->bot_position6); //无人机拉力
      this->cableForce3 = this->CalForce(_force6p,this->pos,this->bot_position6); //质点拉力
      //display the Length of force on the terminal
...
//    std::cerr <<"base_link rot:"<< this->toplinkattitude<<'\n';
    this->force_dir=bot_pos- this->toplinkposition  ; //拉力方向为两点连线
//     std::cerr <<"distance :"<< this->distance<<'\n';
    this->force_dir=this->test  ; //拉力数值向上，用来测试频率与力的影响
