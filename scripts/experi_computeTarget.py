...
class CDPR(gym.Env):
    ...
    def run_xyz(self):
        ...
        while not rospy.is_shutdown():
            ...
            # self.pausePhysics()
            #
            force_logger0, force_logger1, force_logger2, force_logger3 = self.compute_force(22.88, 22.88, 22.88,self.payload_gravity,self.drone_gravity, pid)
        ...
        sio.savemat(self.saveData_dir + '/3droneData.mat',
                    dict(state_drone1=self.state_drone1, state_drone2=self.state_drone2, state_drone3=self.state_drone3,
                         state_payload=self.state_payload, force_drone1=self.force_drone1,
                         force_drone2=self.force_drone2, force_drone3=self.force_drone3,
    ...
    def compute_force(self,throttle1,throttle2,throttle3, payload_gravity,drone_gravity, pid):
        ...
        print('***************************')
        # 保存力的数据 向量
        self.force_drone1.append(force_cableDrone1)
        self.force_drone2.append(force_cableDrone2)
        self.force_drone3.append(force_cableDrone3)
        self.force_logger0.append(force_valueLogger0 * delta_load2logger0)
