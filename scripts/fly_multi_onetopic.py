...
class CDPR(gym.Env):
    ...
    def run_xyz(self):
        ...
        sio.savemat(self.saveData_dir + '/data.mat', {'state_logger0': self.state_logger0,
                                                      'state_logger1': self.state_logger1,
                                                      'state_logger2': self.state_logger2,
                                                      'state_logger3': self.state_logger3,
                                                      'state_drone1': self.state_drone1,
                                                      'state_drone2': self.state_drone2,
                                                      'state_drone3': self.state_drone3,
                                                      'state_payload': self.state_payload,
                                                      'force_drone1': self.force_drone1,
                                                      'force_drone2': self.force_drone2,
                                                      'force_drone3': self.force_drone3,
                                                      'force_logger0': self.force_logger0,
                                                      'force_logger1': self.force_logger1,
                                                      'force_logger2': self.force_logger2,
                                                      'force_logger3': self.force_logger3,
                                                      })
