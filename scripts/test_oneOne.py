...
class CDPR(gym.Env):
    def __init__(self):
        ...
        print ('connected')
        ## ROS Subscribers
        self.state_sub1 = rospy.Subscriber("/drone1/mavros/state",State, self.state_cb,queue_size=100)
        self.state_sub2 = rospy.Subscriber("/drone2/mavros/state",State, self.state_cb,queue_size=100)
        self.state_sub3 = rospy.Subscriber("/drone3/mavros/state",State, self.state_cb,queue_size=100)
        self.imu_sub1 = rospy.Subscriber("/drone1/mavros/imu/data",Imu, self.imu_cb, queue_size=100)
        self.imu_sub2 = rospy.Subscriber("/drone2/mavros/imu/data",Imu, self.imu_cb, queue_size=100)
        self.imu_sub3 = rospy.Subscriber("/drone3/mavros/imu/data",Imu, self.imu_cb, queue_size=100)
        self.local_pos_sub1 = rospy.Subscriber("/drone1/mavros/local_position/pose", PoseStamped, self.lp_cb, queue_size=100)
        # self.local_pos_sub2 = rospy.Subscriber("/drone2/mavros/local_position/pose", PoseStamped, self.lp_cb, queue_size=100)
        # self.local_pos_sub3 = rospy.Subscriber("/drone3/mavros/local_position/pose", PoseStamped, self.lp_cb, queue_size=100)
        self.local_vel_sub1 = rospy.Subscriber("/drone1/mavros/local_position/velocity_local", TwistStamped, self.lv_cb1, queue_size=100)
        self.local_vel_sub2 = rospy.Subscriber("/drone2/mavros/local_position/velocity_local", TwistStamped, self.lv_cb2, queue_size=100)
        self.local_vel_sub3 = rospy.Subscriber("/drone3/mavros/local_position/velocity_local", TwistStamped, self.lv_cb3, queue_size=100)

        # self.act_control_sub1 = rospy.Subscriber("/drone1/mavros/act_control/act_control_pub", ActuatorControl, self.act_cb,queue_size=100)
        # self.act_control_sub2 = rospy.Subscriber("/drone2/mavros/act_control/act_control_pub", ActuatorControl, self.act_cb,queue_size=100)
        # self.act_control_sub3 = rospy.Subscriber("/drone3/mavros/act_control/act_control_pub", ActuatorControl, self.act_cb,queue_size=100)

        self.global_alt_sub1 = rospy.Subscriber("/drone1/mavros/global_position/rel_alt", Float64, self.ra_cb, queue_size=100)
        self.global_alt_sub2 = rospy.Subscriber("/drone2/mavros/global_position/rel_alt", Float64, self.ra_cb, queue_size=100)
        self.global_alt_sub3 = rospy.Subscriber("/drone3/mavros/global_position/rel_alt", Float64, self.ra_cb, queue_size=100)
        self.global_pos_sub1 = rospy.Subscriber("/drone1/mavros/global_position/gp_vel", TwistStamped, self.gv_cb, queue_size=100)
        self.global_pos_sub2 = rospy.Subscriber("/drone2/mavros/global_position/gp_vel", TwistStamped, self.gv_cb, queue_size=100)
        self.global_pos_sub3 = rospy.Subscriber("/drone3/mavros/global_position/gp_vel", TwistStamped, self.gv_cb, queue_size=100)

        self.battery_sub1 = rospy.Subscriber("/drone1/mavros/battery",BatteryState, self.bat_cb, queue_size=100)
        self.battery_sub2 = rospy.Subscriber("/drone2/mavros/battery",BatteryState, self.bat_cb, queue_size=100)
        self.battery_sub3 = rospy.Subscriber("/drone3/mavros/battery",BatteryState, self.bat_cb, queue_size=100)
        self.rc_out1 = rospy.Subscriber("/drone1/mavros/rc/out", RCOut, self.rc_cb1, queue_size=100)
        self.rc_out2 = rospy.Subscriber("/drone2/mavros/rc/out", RCOut, self.rc_cb2, queue_size=100)
        self.rc_out3 = rospy.Subscriber("/drone3/mavros/rc/out", RCOut, self.rc_cb3, queue_size=100)
        self.rc_in1 = rospy.Subscriber("/drone1/mavros/rc/in", RCIn, self.rcIn_cb1, queue_size=100)
        self.rc_in2 = rospy.Subscriber("/drone2/mavros/rc/in", RCIn, self.rcIn_cb2, queue_size=100)
        self.rc_in3 = rospy.Subscriber("/drone3/mavros/rc/in", RCIn, self.rcIn_cb3, queue_size=100)
        ...
        self.acutator_control_pub2 = rospy.Publisher("/drone2/mavros/actuator_control",ActuatorControl,queue_size=100)
        self.acutator_control_pub3 = rospy.Publisher("/drone3/mavros/actuator_control",ActuatorControl,queue_size=100)
        self.setpoint_raw_pub1 = rospy.Publisher("/drone1/mavros/setpoint_raw/attitude",AttitudeTarget,queue_size=100)
        self.setpoint_raw_pub2 = rospy.Publisher("/drone2/mavros/setpoint_raw/attitude",AttitudeTarget,queue_size=100)
        self.setpoint_raw_pub3 = rospy.Publisher("/drone3/mavros/setpoint_raw/attitude",AttitudeTarget,queue_size=100)  # NED
        self.setposition_raw_pub1 = rospy.Publisher("/drone1/mavros/setpoint_raw/local",PositionTarget,queue_size=100)  # NED
        self.setposition_raw_pub2 = rospy.Publisher("/drone2/mavros/setpoint_raw/local",PositionTarget,queue_size=100)  # NED
        self.setposition_raw_pub3 = rospy.Publisher("/drone3/mavros/setpoint_raw/local",PositionTarget,queue_size=100)  # NED
        self.setglobalpos_raw_pub1 = rospy.Publisher("/drone1/mavros/setpoint_raw/global",GlobalPositionTarget,queue_size=100)  # NED
        self.setglobalpos_raw_pub2 = rospy.Publisher("/drone2/mavros/setpoint_raw/global",GlobalPositionTarget,queue_size=100)  # NED
        self.setglobalpos_raw_pub3 = rospy.Publisher("/drone3/mavros/setpoint_raw/global",GlobalPositionTarget,queue_size=100)  # NED

        self.local_pos_pub1 = rospy.Publisher("/drone1/mavros/setpoint_position/local",PoseStamped,queue_size=100) #ENU
        self.local_pos_pub2 = rospy.Publisher("/drone2/mavros/setpoint_position/local",PoseStamped,queue_size=100)
        self.local_pos_pub3 = rospy.Publisher("/drone3/mavros/setpoint_position/local",PoseStamped,queue_size=100)
        self.setcmd_vel_pub1 = rospy.Publisher("/drone1/mavros/setpoint_velocity/cmd_vel_unstamped",Twist,queue_size=100)
        self.setcmd_vel_pub2 = rospy.Publisher("/drone2/mavros/setpoint_velocity/cmd_vel_unstamped",Twist,queue_size=100)
        self.setcmd_vel_pub3 = rospy.Publisher("/drone3/mavros/setpoint_velocity/cmd_vel_unstamped",Twist,queue_size=100)
        self.thrust_pub1 = rospy.Publisher("/drone1/mavros/setpoint_attitude/thrust",Thrust,queue_size=100)
        self.thrust_pub2 = rospy.Publisher("/drone2/mavros/setpoint_attitude/thrust",Thrust,queue_size=100)
        self.thrust_pub3 = rospy.Publisher("/drone3/mavros/setpoint_attitude/thrust",Thrust,queue_size=100)
        self.setattitude_pub1 = rospy.Publisher("/drone1/mavros/setpoint_attitude/attitude", PoseStamped,queue_size=100)
        self.setattitude_pub2 = rospy.Publisher("/drone2/mavros/setpoint_attitude/attitude", PoseStamped,queue_size=100)
        self.setattitude_pub3 = rospy.Publisher("/drone3/mavros/setpoint_attitude/attitude", PoseStamped,queue_size=100)  # ENU

        self.rc_override1 = rospy.Publisher("/drone1/mavros/rc/override", OverrideRCIn, queue_size=100)
        self.rc_override2 = rospy.Publisher("/drone2/mavros/rc/override", OverrideRCIn, queue_size=100)
        self.rc_override3 = rospy.Publisher("/drone3/mavros/rc/override", OverrideRCIn, queue_size=100)
        ...
        self.force_publisher5 = rospy.Publisher('/drone2/testforce', Float32MultiArray, queue_size=100)
        self.force_publisher6 = rospy.Publisher('/drone3/testforce', Float32MultiArray, queue_size=100)
    ...
    def run_xyz(self):
        ...
        while not rospy.is_shutdown():
            ...
            if drone1_fly == True and dist_cone2drone1>=5:
                ...
                force_payload2cable = self.payload_gravity*40+self.Coeff_elasticity*(dist_cone2drone1-5)*40
                self.force_cable1 = self.force_cable1+self.Coeff_elasticity*(dist_cone2drone1-5)*40
            ...
            #     # if drone2_fly == True:
            #     #     multiarray5.data = [dist_cone2drone2, self.cable_length, self.Coeff_elasticity]
            #     self.force_cable2 = self.force_cable2+5*(dist_cone2drone2-5)*100
            ...
            #     # if drone3_fly == True:
            #     #     multiarray6.data = [dist_cone2drone3, self.cable_length, self.Coeff_elasticity]
            #     self.force_cable3 = self.force_cable3+5*(dist_cone2drone3-5)*100
            #     multiarray6.data = [self.force_cable3] # 拉力大小
            #     self.unpausePhysics()
            #     self.force_publisher6.publish(multiarray6)

            self.pausePhysics()
            force_logger2 = self.compute_force(22,22,22,self.payload_gravity,self.drone_gravity,pid)
            ...
            self.unpausePhysics()
            force0_error, force1_error,force2_error = pid.cal_actions(payload_position)
            # multiarray0.data = [force2_error*100]
            # print('carForce',force2_error*100)
            # self.force_publisher0.publish(multiarray0)

            # if drone1_fly and payload_position[2]>0.1:
            #     # multiarray0.data = [force_logger0*100]
            #     # multiarray1.data = [force_logger1*100]
            #     multiarray2.data = [force_logger2*40]
            #     # multiarray3.data = [force_logger3*100]
    ...
    def compute_force(self,throttle1,throttle2,throttle3, payload_gravity,drone_gravity, pid):
        ...
        # 负载与小车间的力的方向,指向小车
        delta_load2logger0 = [logger0_position[0] - payload_position[0],logger0_position[1]-payload_position[1],logger0_position[2]-(payload_position[2]+0.1)]
        delta_load2logger1 = [logger1_position[0] - payload_position[0],logger1_position[1]-payload_position[1],logger1_position[2]-(payload_position[2]+0.1)]
        delta_load2logger2 = [logger2_position[0] - payload_position[0],logger2_position[1]-payload_position[1],logger2_position[2]-(payload_position[2]+0.1)]
        delta_load2logger3 = [logger3_position[0] - payload_position[0],logger3_position[1]-payload_position[1],logger3_position[2]-(payload_position[2]+0.1)]
        ...
        # 绳子方向,指向负载
        delta_load2drone1 = [payload_position[0]-drone1_position[0],payload_position[1]-drone1_position[1],payload_position[2]+0.1-drone1_position[2]]
        delta_load2drone2 = [payload_position[0]-drone2_position[0],payload_position[1]-drone2_position[1],payload_position[2]+0.1-drone2_position[2]]
        delta_load2drone3 = [payload_position[0]-drone3_position[0],payload_position[1]-drone3_position[1],payload_position[2]+0.1-drone3_position[2]]
        #归一化
        ...
        force_cable3 = drone_gravity*np.cos(theta_cableDrone3) - throttle3 *np.cos(theta_cableDrone3)
        ...
        # publish
        self.force_cable1 = np.abs(force_cable1)*40
        self.force_cable2 = np.abs(force_cable2)*40
        self.force_cable3 = np.abs(force_cable3)*40
        ...
        from optimizer_oneOne import minimizeForce
        allArgs = (target_forceLogger0123,delta_load2logger2)
        force_valueLogger2 = minimizeForce(allArgs)
        value = force_valueLogger2* delta_load2logger2  - target_forceLogger0123
        # print('value',value)
        print('carforce',force_valueLogger2)
        return force_valueLogger2


    def run_logger(self):

        cmd1 = rospy.Publisher('/logger1/cmd_vel', Twist, queue_size=100)
        cmd0 = rospy.Publisher('/logger0/cmd_vel', Twist, queue_size=100)
        cmd2 = rospy.Publisher('/logger2/cmd_vel', Twist, queue_size=100)
        cmd3 = rospy.Publisher('/logger3/cmd_vel', Twist, queue_size=100)
        multiarray0 = Float32MultiArray()
        multiarray1 = Float32MultiArray()
        multiarray2 = Float32MultiArray()
        multiarray3 = Float32MultiArray()
...
if __name__ == "__main__":
    ...
    # vel = Twist()
    # vel.angular.z = 10
    # force_publisher0 = rospy.Publisher('/logger0/testforce', Float32MultiArray, queue_size=100)
    # force_publisher1 = rospy.Publisher('/logger0/testforce', Float32MultiArray, queue_size=100)
    # force_publisher2 = rospy.Publisher('/logger0/testforce', Float32MultiArray, queue_size=100)
    # force_publisher3 = rospy.Publisher('/logger0/testforce', Float32MultiArray, queue_size=100)
    # while not rospy.is_shutdown():
    #     vel.linear.x = np.random.uniform(2)
    #     # vel.linear.x = 0
    #     # print('ssssss')
