...
class CDPR(gym.Env):
    def __init__(self):
        ...
        print ('connected')
        ## ROS Subscribers
        self.state_sub1 = rospy.Subscriber("/drone1/mavros/state",State, self.state_cb,queue_size=10)
        self.state_sub2 = rospy.Subscriber("/drone2/mavros/state",State, self.state_cb,queue_size=10)
        self.state_sub3 = rospy.Subscriber("/drone3/mavros/state",State, self.state_cb,queue_size=10)
        self.imu_sub1 = rospy.Subscriber("/drone1/mavros/imu/data",Imu, self.imu_cb, queue_size=10)
        self.imu_sub2 = rospy.Subscriber("/drone2/mavros/imu/data",Imu, self.imu_cb, queue_size=10)
        self.imu_sub3 = rospy.Subscriber("/drone3/mavros/imu/data",Imu, self.imu_cb, queue_size=10)
        self.local_pos_sub1 = rospy.Subscriber("/drone1/mavros/local_position/pose", PoseStamped, self.lp_cb, queue_size=10)
        self.local_pos_sub2 = rospy.Subscriber("/drone2/mavros/local_position/pose", PoseStamped, self.lp_cb, queue_size=10)
        self.local_pos_sub3 = rospy.Subscriber("/drone3/mavros/local_position/pose", PoseStamped, self.lp_cb, queue_size=10)
        self.local_vel_sub1 = rospy.Subscriber("/drone1/mavros/local_position/velocity_local", TwistStamped, self.lv_cb1, queue_size=10)
        self.local_vel_sub2 = rospy.Subscriber("/drone2/mavros/local_position/velocity_local", TwistStamped, self.lv_cb2, queue_size=10)
        self.local_vel_sub3 = rospy.Subscriber("/drone3/mavros/local_position/velocity_local", TwistStamped, self.lv_cb3, queue_size=10)

        self.act_control_sub1 = rospy.Subscriber("/drone1/mavros/act_control/act_control_pub", ActuatorControl, self.act_cb,queue_size=10)
        self.act_control_sub2 = rospy.Subscriber("/drone2/mavros/act_control/act_control_pub", ActuatorControl, self.act_cb,queue_size=10)
        self.act_control_sub3 = rospy.Subscriber("/drone3/mavros/act_control/act_control_pub", ActuatorControl, self.act_cb,queue_size=10)

        self.global_alt_sub1 = rospy.Subscriber("/drone1/mavros/global_position/rel_alt", Float64, self.ra_cb, queue_size=10)
        self.global_alt_sub2 = rospy.Subscriber("/drone2/mavros/global_position/rel_alt", Float64, self.ra_cb, queue_size=10)
        self.global_alt_sub3 = rospy.Subscriber("/drone3/mavros/global_position/rel_alt", Float64, self.ra_cb, queue_size=10)
        self.global_pos_sub1 = rospy.Subscriber("/drone1/mavros/global_position/gp_vel", TwistStamped, self.gv_cb, queue_size=10)
        self.global_pos_sub2 = rospy.Subscriber("/drone2/mavros/global_position/gp_vel", TwistStamped, self.gv_cb, queue_size=10)
        self.global_pos_sub3 = rospy.Subscriber("/drone3/mavros/global_position/gp_vel", TwistStamped, self.gv_cb, queue_size=10)

        self.battery_sub1 = rospy.Subscriber("/drone1/mavros/battery",BatteryState, self.bat_cb, queue_size=10)
        self.battery_sub2 = rospy.Subscriber("/drone2/mavros/battery",BatteryState, self.bat_cb, queue_size=10)
        self.battery_sub3 = rospy.Subscriber("/drone3/mavros/battery",BatteryState, self.bat_cb, queue_size=10)
        self.rc_out1 = rospy.Subscriber("/drone1/mavros/rc/out", RCOut, self.rc_cb1, queue_size=10)
        self.rc_out2 = rospy.Subscriber("/drone2/mavros/rc/out", RCOut, self.rc_cb2, queue_size=10)
        self.rc_out3 = rospy.Subscriber("/drone3/mavros/rc/out", RCOut, self.rc_cb3, queue_size=10)
        self.rc_in1 = rospy.Subscriber("/drone1/mavros/rc/in", RCIn, self.rcIn_cb1, queue_size=10)
        self.rc_in2 = rospy.Subscriber("/drone2/mavros/rc/in", RCIn, self.rcIn_cb2, queue_size=10)
        self.rc_in3 = rospy.Subscriber("/drone3/mavros/rc/in", RCIn, self.rcIn_cb3, queue_size=10)


        ## ROS Publishers
        # self.mocap_pos_pub = rospy.Publisher("/drone1/mavros/mocap/pose",PoseStamped,queue_size=10)
        self.acutator_control_pub1 = rospy.Publisher("/drone1/mavros/actuator_control",ActuatorControl,queue_size=10)
        self.acutator_control_pub2 = rospy.Publisher("/drone2/mavros/actuator_control",ActuatorControl,queue_size=10)
        self.acutator_control_pub3 = rospy.Publisher("/drone3/mavros/actuator_control",ActuatorControl,queue_size=10)
        self.setpoint_raw_pub1 = rospy.Publisher("/drone1/mavros/setpoint_raw/attitude",AttitudeTarget,queue_size=10)
        self.setpoint_raw_pub2 = rospy.Publisher("/drone2/mavros/setpoint_raw/attitude",AttitudeTarget,queue_size=10)
        self.setpoint_raw_pub3 = rospy.Publisher("/drone3/mavros/setpoint_raw/attitude",AttitudeTarget,queue_size=10)  # NED
        self.setposition_raw_pub1 = rospy.Publisher("/drone3/mavros/setpoint_raw/local",PositionTarget,queue_size=10)  # NED
        self.setposition_raw_pub2 = rospy.Publisher("/drone3/mavros/setpoint_raw/local",PositionTarget,queue_size=10)  # NED
        self.setposition_raw_pub3 = rospy.Publisher("/drone3/mavros/setpoint_raw/local",PositionTarget,queue_size=10)  # NED
        ...
        self.local_pos_pub3 = rospy.Publisher("/drone3/mavros/setpoint_position/local",PoseStamped,queue_size=10)
        self.setcmd_vel_pub1 = rospy.Publisher("/drone1/mavros/setpoint_velocity/cmd_vel_unstamped",Twist,queue_size=10)
        self.setcmd_vel_pub2 = rospy.Publisher("/drone2/mavros/setpoint_velocity/cmd_vel_unstamped",Twist,queue_size=10)
        self.setcmd_vel_pub3 = rospy.Publisher("/drone3/mavros/setpoint_velocity/cmd_vel_unstamped",Twist,queue_size=10)
        self.thrust_pub1 = rospy.Publisher("/drone1/mavros/setpoint_attitude/thrust",Thrust,queue_size=10)
        self.thrust_pub2 = rospy.Publisher("/drone2/mavros/setpoint_attitude/thrust",Thrust,queue_size=10)
        self.thrust_pub3 = rospy.Publisher("/drone3/mavros/setpoint_attitude/thrust",Thrust,queue_size=10)
        self.setattitude_pub1 = rospy.Publisher("/drone1/mavros/setpoint_attitude/attitude", PoseStamped,queue_size=10)
        self.setattitude_pub2 = rospy.Publisher("/drone2/mavros/setpoint_attitude/attitude", PoseStamped,queue_size=10)
        self.setattitude_pub3 = rospy.Publisher("/drone3/mavros/setpoint_attitude/attitude", PoseStamped,queue_size=10)  # ENU

        self.rc_override1 = rospy.Publisher("/drone1/mavros/rc/override", OverrideRCIn, queue_size=10)
        self.rc_override2 = rospy.Publisher("/drone2/mavros/rc/override", OverrideRCIn, queue_size=10)
        self.rc_override3 = rospy.Publisher("/drone3/mavros/rc/override", OverrideRCIn, queue_size=10)

        self.force_publisher0 = rospy.Publisher('/logger0/testforce', Float32MultiArray, queue_size=10)
        self.force_publisher1 = rospy.Publisher('/logger1/testforce', Float32MultiArray, queue_size=10)
        self.force_publisher2 = rospy.Publisher('/logger2/testforce', Float32MultiArray, queue_size=10)
        self.force_publisher3 = rospy.Publisher('/logger3/testforce', Float32MultiArray, queue_size=10)
        self.force_publisher4 = rospy.Publisher('/drone1/testforce', Float32MultiArray, queue_size=10)
        self.force_publisher5 = rospy.Publisher('/drone2/testforce', Float32MultiArray, queue_size=10)
        self.force_publisher6 = rospy.Publisher('/drone3/testforce', Float32MultiArray, queue_size=10)
        ...
        #         self.offb_arm()
        #         self.takeoff_service1(altitude=5)
        #     if np.abs(self.local_position.pose.position.z - 5) < 0.5:
        #         break
        ...
        id_payload = self.model_states.name.index("cone")  #
    ...
    def run(self):
        ...
        while not rospy.is_shutdown():
            ...
            self.pausePhysics()
            # logger
            model_name = ['logger0', 'logger1', 'logger2', 'logger3', 'drone1', 'drone2', 'drone3', 'cone']
    ...
    def run_xyz(self):
        ...
        while not rospy.is_shutdown():
            ...
            # self.takeoff_service1(altitude=8)
            # self.takeoff_service2(altitude=8)
            # self.takeoff_service3(altitude=8)
            #
            attitude = AttitudeTarget()
            roll = 0.0
            pitch = 0.0
            ...
            #         self.setcmd_vel_pub1.publish(velocity)
            # if drone2_fly == True:
            #     if self.local_velocity2.twist.linear.x >2.5:
            #         velocity.linear.x = 2.5
            #         self.setcmd_vel_pub2.publish(velocity)
            #     elif self.local_velocity2.twist.linear.x <-2.5:
            #         velocity.linear.x = -2.5
            #         self.setcmd_vel_pub2.publish(velocity)
            #     if self.local_velocity2.twist.linear.y>2.5:
            #         velocity.linear.y = 2.5
            #         self.setcmd_vel_pub2.publish(velocity)
            #     elif self.local_velocity2.twist.linear.y<-2.5:
            #         velocity.linear.y = -2.5
            #         self.setcmd_vel_pub2.publish(velocity)
            # if drone3_fly == True:
            #     if self.local_velocity3.twist.linear.x >2.5:
            #         velocity.linear.x = 2.5
            #         self.setcmd_vel_pub3.publish(velocity)
            #     elif self.local_velocity3.twist.linear.x <-2.5:
            #         velocity.linear.x = -2.5
            #         self.setcmd_vel_pub3.publish(velocity)
            #     if self.local_velocity3.twist.linear.y>2.5:
            #         velocity.linear.y = 2.5
            #         self.setcmd_vel_pub3.publish(velocity)
            #     elif self.local_velocity3.twist.linear.y<-2.5:
            #         velocity.linear.y = -2.5
            #         self.setcmd_vel_pub3.publish(velocity)
            ...
            # # if drone1_fly == True:
            # #     multiarray4.data = [dist_cone2drone1, self.cable_length, self.Coeff_elasticity] # 距离，绳长，弹性系数
            #     multiarray4.data = [self.force_cable1] # 拉力大小
            #     self.force_publisher4.publish(multiarray4)
            # if drone2_fly == True and dist_cone2drone2>=5:
            # # if drone2_fly == True:
            # #     multiarray5.data = [dist_cone2drone2, self.cable_length, self.Coeff_elasticity]
            #     multiarray5.data = [self.force_cable2] # 拉力大小
            #     self.force_publisher5.publish(multiarray5)
            # if drone3_fly == True and dist_cone2drone3>=5:
            # # if drone3_fly == True:
            # #     multiarray6.data = [dist_cone2drone3, self.cable_length, self.Coeff_elasticity]
            #     multiarray6.data = [self.force_cable3] # 拉力大小
            #     self.force_publisher6.publish(multiarray6)
            # self.rate.sleep()

            # self.pausePhysics()
            force_logger0,force_logger1,force_logger2,force_logger3 = self.compute_force(30,30,30,self.cable_gravity,self.drone_gravity,pid)
            ...
            # if drone1_fly and payload_position[2]>0.01:
            #     multiarray0.data = [force_logger0]
            #     multiarray1.data = [force_logger1]
            #     multiarray2.data = [force_logger2]
            #     multiarray3.data = [force_logger3]
            #     self.force_publisher0.publish(multiarray0)
            #     self.force_publisher1.publish(multiarray1)
            #     self.force_publisher2.publish(multiarray2)
            #     self.force_publisher3.publish(multiarray3)
    ...
    def compute_force(self,throttle1,throttle2,throttle3, cable_gravity,drone_gravity, pid):
        '''

        :param throttle1: 无人机1推力
        :param throttle2: 无人机2推力
        :param throttle3: 无人机3推力
        :param cable_gravity: 负载重力
        :param pid: pid控制器
        :return: 返回小车拉力大小
        '''
        model_name = ['logger0', 'logger1', 'logger2', 'logger3', 'drone1', 'drone2', 'drone3', 'cone']
        ...
        #绳子与竖直方向夹角
        theta_cableDrone1 = np.arctan(np.sqrt(np.sum(np.square([delta_load2drone1[0],delta_load2drone1[1]])))/np.abs(delta_load2drone1[2]))
        theta_cableDrone2 = np.arctan(np.sqrt(np.sum(np.square([delta_load2drone2[0],delta_load2drone2[1]])))/np.abs(delta_load2drone2[2]))
        theta_cableDrone3 = np.arctan(np.sqrt(np.sum(np.square([delta_load2drone3[0],delta_load2drone3[1]])))/np.abs(delta_load2drone3[2]))
        # 绳子方向上受的合力大小
        force_cable1 =  drone_gravity*np.cos(theta_cableDrone1) - throttle1 *np.cos(theta_cableDrone1)
        force_cable2 =  drone_gravity*np.cos(theta_cableDrone2) - throttle2 *np.cos(theta_cableDrone2)
        force_cable3 =  drone_gravity*np.cos(theta_cableDrone2) - throttle3 *np.cos(theta_cableDrone3)
        # 绳子方向上无人机受的合力(方向+大小)
        dirforce_cable1 = force_cable1*delta_load2drone1
        dirforce_cable2 = force_cable2*delta_load2drone2
        dirforce_cable3 = force_cable3*delta_load2drone3
        self.force_cable1 = np.abs(force_cable1)*10
        self.force_cable2 = np.abs(force_cable2)*10
        self.force_cable3 = np.abs(force_cable3)*10
        # print(self.force_cable1,self.force_cable2,self.force_cable3)
        # pid
        ...
        # 目标小车合力
        # force_pid = [0,0,0]
        target_forceLogger0123 = force_pid -  dirforce_cable1 - dirforce_cable2 - dirforce_cable3 - [0,0,-cable_gravity]
    ...
    def save2list(self):
        models_name = ['logger0','logger1','logger2','logger3','drone1','drone2','drone3','cone']
...
class apmPID:
    def __init__(self,target):
        # 位置式
        self.control_x = PID_posi(3, 0, 0.001, target[0], up=500, low=-500)  # control position x
        self.control_y = PID_posi(3, 0., 0.002, target[1], up=500, low=-500)  # control position y
        self.control_z = PID_posi(3, 0.0, 1.5, target[2], up=500, low= -500)  # control position z
        # 增量式
...
if __name__ == "__main__":
    ...
    # force_publisher1 = rospy.Publisher('/logger0/testforce', Float32MultiArray, queue_size=10)
    # force_publisher2 = rospy.Publisher('/logger0/testforce', Float32MultiArray, queue_size=10)
    # force_publisher3 = rospy.Publisher('/logger0/testforce', Float32MultiArray, queue_size=10)
    # while not rospy.is_shutdown():
    #     vel.linear.x = np.random.uniform(2)
    #     # vel.linear.x = 0
    #     # print('ssssss')
