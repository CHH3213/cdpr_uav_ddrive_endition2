...
class CDPR(gym.Env):
    ...
    def run_xyz(self):
        ...
        while not rospy.is_shutdown():
            ...
            # thrust = 0.01894*PWM_all - 99.63
            thrust1 = 0.01894*(self.rc_states1.channels[0]+self.rc_states1.channels[1]+self.rc_states1.channels[2]+self.rc_states1.channels[3])-99.63
            thrust2 = 0.01894*(self.rc_states2.channels[0]+self.rc_states2.channels[1]+self.rc_states2.channels[2]+self.rc_states2.channels[3])-99.63
            thrust3 = 0.01894*(self.rc_states3.channels[0]+self.rc_states3.channels[1]+self.rc_states3.channels[2]+self.rc_states3.channels[3])-99.63
            ...
            force_payload2cable11 = self.force_cable1 / 5 * self.dist_load2drone1
            force_payload2cable11 = self.force_cable1 - self.Coeff_elasticity * (self.dist_load2drone1 - 5) * 100
            ...
            force_payload2cable22 = self.force_cable2 /5*self.dist_load2drone2
            # force_payload2cable22 = self.force_cable2 - self.Coeff_elasticity*(self.dist_load2drone2-5)* 100
            ...
            force_payload2cable33 = self.force_cable3 / 5 * self.dist_load2drone3
            # force_payload2cable33 = self.force_cable3 - self.Coeff_elasticity * (self.dist_load2drone3 - 5) * 100
            ...
            # elif self.drone1_position[2] > 0 and self.dist_load2drone1 < 5 and self.payload_linear[2] < 0:
            #     # multiarray4.data = [0, 1.0 * 9.8 * 100+self.Coeff_elasticity*(self.dist_load2drone1-5)*100]
            #     multiarray4.data = [0, force_payload2cable11, count1]
            #     # multiarray4.data = [0,force_payload2drone1, count1]
            #     flag = False
            #     flag_drone1 = False
            #     # print('hahahha1')
            # else:
            ...
            # elif  self.drone2_position[2] > 0 and self.dist_load2drone2 < 5 and self.payload_linear[2] < 0:
            #     # multiarray4.data = [0, 1.0 * 9.8 * 100+self.Coeff_elasticity*(self.dist_load2drone1-5)*100]
            #     multiarray5.data = [0, force_payload2cable22 ,count2]
            #     # multiarray5.data = [0, force_payload2drone2 ,count2]
            #     flag = False
            #     flag_drone2 = False
            #     # print('hahahha2')
            # else:
            ...
            # elif self.drone3_position[2] > 0 and self.dist_load2drone3 < 5 and self.payload_linear[2] < 0:
            #     # multiarray6.data = [0, 1.0 * 9.8 * 100+self.Coeff_elasticity*(self.dist_load2drone1-5)*100]
            #     multiarray6.data = [0, force_payload2cable33 ,count3]
            #     # multiarray6.data = [0, force_payload2drone3 ,count3]
            #     flag = False
            #     # print('hahahha3')
            #     flag_drone3 = False
            # else:
            ...
            # 2 斜率形式
            # drone1
            if self.drone1_position[2] > 1 :
                multiarray4.data = [force_payload2cable1/4, force_payload2drone1, count1]  # 拉力大小
                count += 1
            ...
            # drone2
            if self.drone2_position[2] > 1 :
                multiarray5.data = [force_payload2cable2/4, force_payload2drone2, count2]  # 拉力大小
            ...
            # drone3
            if self.drone3_position[2] > 1 :
                multiarray6.data = [force_payload2cable3/4, force_payload2drone3, count3]  # 拉力大小
            ...
            if self.drone1_position[2]>0  and self.drone2_position[2]>0 and self.drone3_position[2]>0 and self.payload_position[2]>0.5 :
            ...
            self.cable_drone1.append(force_payload2drone1)  # 绳子拉力
            self.cable_drone2.append(force_payload2drone2)
            self.cable_drone3.append(force_payload2drone3)
            # # 画图数据
            ...
            if count_draw == 600:
                ...
                plt.savefig('/home/chh3213/ros_wc/src/cdpr_uav_ddrive/scripts/force_3d.png')
                count_draw = 1
                plt.figure(2)
                ...
                plt.savefig('/home/chh3213/ros_wc/src/cdpr_uav_ddrive/scripts/PayloadPos_3d.png')
                plt.show()
                break
        ...
        sio.savemat(self.saveData_dir + '/3droneData.mat',
                    dict(state_drone1=self.state_drone1, state_drone2=self.state_drone2, state_drone3=self.state_drone3,
                         state_payload=self.state_payload, force_drone1=self.cable_drone1,
                         force_drone2=self.cable_drone2, force_drone3=self.cable_drone3,
    ...
    def run_last(self):
        ...
        while not rospy.is_shutdown():
            ...
            # count3 += 1
            ##################################################
            force_logger0, force_logger1, force_logger2, force_logger3 = self.compute_LoggerForce(force_payload2drone1/100, force_payload2drone2/100, force_payload2drone3/100,self.payload_gravity,self.drone_gravity, pid)
            ########################################################


            if self.payload_position[2]>0.5 :
                multiarray0.data = [force_logger0*100, force_logger1*100, force_logger2*100, force_logger3*100, count4]
            ...
            if count_draw == 1100:
                ...
                plt.savefig('/home/chh3213/ros_wc/src/cdpr_uav_ddrive/scripts/DronePos_3d.png')
                plt.show()
                break
    ...
    def compute_force(self,throttle1,throttle2,throttle3, payload_gravity,drone_gravity, pid):
        ...
        # print('a', ori_throttle1)


        # print(thrust3)

        # print('a', theta_cableThrottle1)
        # print('1', np.sum([a*b for a,b in zip(thrust1,delta_load2drone1)]))
        ...
        # print('cable',force_cable1)
        # 绳子方向上负载理论上受到 的绳子拉力(方向+大小)
        print(delta_load2drone1)
...
class apmPID:
    def __init__(self,target):
        ...
        self.control_z = PID(np.asarray([0.04*z_p, 0.00*z_i, 0.08*z_d])*z, target[2], upper=10, lower= -10)  # control position z
